...
return [
    ...
    'attributes'           => [
        ...
        'user_password'                 =>'用户密码',
        'user_captcha'                 =>'验证码',
        'user_email_captcha'                 =>'验证码',
        'user_email_captcha_email'                 =>'验证码',
        'user_email_captcha_email_email'                 =>'验证码',
        'user_email_captcha_email_email_email'                 =>'验证码',
        'user_email_captcha_email_email_email_email'                 =>'验证码',
